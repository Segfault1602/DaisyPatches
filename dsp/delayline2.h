...
DelayLine2<float, SAMPLE_RATE> del;

By: shensley
Original code from DaisySP

Diff:
    - August 2022: TapIn method added.
*/
...
class DelayLine2
{
  public:
    ...
    */
    ...
    /** writes in a sample of type T to the delay line, at sample `tapDelay`
     */
    inline void TapIn(const T sample, size_t tapDelay)
    {
        line_[(write_ptr_ + tapDelay + 1) % max_size] = sample;
    }
